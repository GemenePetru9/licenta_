...
public class ShiftReplacement extends BaseAdapter {
    ...
    public ShiftReplacement(Context context, ArrayList<Client> employeeData,String day) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ShiftReplacement.ViewHolder holder;

        if (convertView == null) {

            holder = new ShiftReplacement.ViewHolder();
            convertView = mInflaterCatalogListItems.inflate(R.layout.shift_replacement,
                    null);
            holder.sEmployeeName = (TextView) convertView.findViewById(R.id.textViewNumeAngajatReplacement);
            holder.sEmployeeShift = (TextView) convertView.findViewById(R.id.simpleCheckedTextView);
            ...
            holder = (ShiftReplacement.ViewHolder) convertView.getTag();
        }


        //Change the content here
        if (mEmployeeData.get(position) != null) {
            String nume=mEmployeeData.get(position).getNume()+" "+mEmployeeData.get(position).getPrenume();
            holder.sEmployeeName.setText(nume);
